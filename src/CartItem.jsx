...
const CartItem = ({ onContinueShopping }) => {
  ...
  const handleContinueShopping = (e) => {
    e.preventDefault();
    onContinueShopping(); // Call the parent function to hide the cart
  };

  // Handle checkout button click (placeholder for future functionality)
  const handleCheckoutShopping = (e) => {
    e.preventDefault();
    alert('Functionality will be added in future');
  };
  ...
  const handleRemove = (item) => {
    dispatch(removeItem({ name: item.name })); // Remove item
  };
